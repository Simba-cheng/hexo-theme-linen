...
class Slide {
  ...
  applyCurrentZoomPan() {
    if (
      this.pswp.gestures.isDragging &&
      !this.pswp.element.classList.contains("action-updating")
    ) {
...
class TapHandler {
  ...
  click(point, originalEvent) {
    const targetClassList =
      /** @type {HTMLElement} */ originalEvent.target.classList;
  ...
  _doClickOrTapAction(actionName, point, originalEvent) {
    ...
    const actionFullName =
      /** @type {AddPostfix<Actions, 'Action'>} */ actionName + "Action";
...
class Eventable {
  ...
  dispatch(name, details) {
    ...
    const event = /** @type {AugmentedEvent<T>} */ new PhotoSwipeEvent(
      name,
      details
    );
